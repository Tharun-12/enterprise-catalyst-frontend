...
export function FeaturedProductsSection() {
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">Popular products chosen by our enterprise clients across various industries.</p>
            </div>
            <Button asChild variant="outline" size="sm" className="rounded-full">
              <Link to="/products" className="flex items-center gap-1">
                View All <ChevronRight className="w-4 h-4" />
  ...
  return (
    <section className="py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        {/* Left-aligned header with gradient text */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          ...
          <Button asChild variant="outline" size="sm" className="rounded-full mt-4 sm:mt-0">
            <Link to="/products" className="flex items-center gap-1">
              View All <ChevronRight className="w-4 h-4" />
            </Link>
          </Button>
