...
// Gradient color pairs for each card - using pink, orange, yellow, blue gradient
const gradientColors = [
  'from-pink-500/10 to-orange-500/10',
  'from-orange-500/10 to-yellow-400/10',
  'from-yellow-400/10 to-blue-500/10',
  'from-blue-500/10 to-pink-500/10',
  'from-pink-500/10 to-yellow-400/10',
  'from-orange-500/10 to-blue-500/10',
];
...
export function ServicesSection() {
  return (
    <section className="relative overflow-hidden py-20 lg:py-28 px-4 sm:px-6 lg:px-8">
      ...
      {/* Decorative background elements */}
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-0 -left-1/4 w-1/2 h-1/2 bg-gradient-to-r from-pink-500/10 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 -right-1/4 w-1/2 h-1/2 bg-gradient-to-l from-blue-500/10 to-transparent rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-gradient-to-b from-yellow-400/5 to-transparent rounded-full blur-3xl" />
      </div>
          ...
          {SERVICES_DATA.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="relative p-7 h-full group overflow-hidden border border-white/10 hover:border-pink-300/50 transition-all duration-300 bg-white/80 backdrop-blur-xl shadow-xl hover:shadow-2xl hover:shadow-pink-500/10">
                  {/* Glass effect background */}
                  ...
                  {/* Animated border glow */}
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-500/0 via-pink-500/20 to-pink-500/0 opacity-0 group-hover:opacity-100 blur-sm transition-opacity duration-500 rounded-xl" />
                  
                  {/* Decorative circle */}
                  <div className="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-gradient-to-r from-pink-500/5 to-blue-500/5 group-hover:from-pink-500/20 group-hover:to-blue-500/20 transition-colors duration-500" />

                  <div className="relative z-10">
                    {/* Icon container with enhanced styling */}
                    <div className="relative w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500/20 to-blue-500/10 backdrop-blur-sm flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 group-hover:shadow-lg group-hover:shadow-pink-500/20 border border-white/50">
                      <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-pink-500 to-blue-500 opacity-0 group-hover:opacity-20 transition-opacity duration-300" />
                      <Icon className="w-7 h-7 text-pink-500 group-hover:text-blue-600 transition-colors duration-300" />
                    </div>

                    {/* Title */}
                    <h3 className="text-xl font-bold mb-3 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-pink-500 group-hover:via-orange-500 group-hover:via-yellow-400 group-hover:to-blue-600 group-hover:bg-clip-text transition-all duration-300">
                      {service.title}
                    </h3>
                    ...
                    {/* Learn more link */}
                    <div className="flex items-center gap-2 text-sm font-medium text-transparent bg-gradient-to-r from-pink-500 via-orange-500 via-yellow-400 to-blue-600 bg-clip-text opacity-0 group-hover:opacity-100 translate-x-[-8px] group-hover:translate-x-0 transition-all duration-300">
                      <span>Learn More</span>
                      <ArrowRight className="w-4 h-4 text-pink-500 group-hover:translate-x-1 transition-transform duration-300" />
                    </div>

                    {/* Number indicator */}
                    <div className="absolute bottom-3 right-4 text-5xl font-bold text-gray-200/50 select-none">
                      {String(i + 1).padStart(2, '0')}
                    </div>
                  </div>
                </Card>
